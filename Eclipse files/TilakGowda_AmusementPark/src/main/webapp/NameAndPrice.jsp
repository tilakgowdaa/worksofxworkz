...
<body
	...
	<h1>Search By Name and EntryFee</h1>
	...
	<form action="findByNameAndPrice" method="get">
		<input type="text" name="name" placeholder="Enter the name" value="">
		<input type="number" name="entryFee" placeholder="Entry fee" value="0">
	...
	<table class="table table-bordered" border="2">
		...
		<c:forEach var="L" items="${dtoNP }">
			<tr>
				...
				<td><a href="deleteInNP?id=${L.id }" class="btn btn-danger">Delete</a></td>
